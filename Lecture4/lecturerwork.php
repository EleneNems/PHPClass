    ...
    <form class="form-1" action="" method="post">
        <div>
            <?php
                ...
                if(isset($_POST['sum'])){
                    echo "<h3>Sum = ".sum(checkData2($_POST['n1'],0), 
                    checkData2($_POST['n2'],0), 
                    checkData2($_POST['n3'],0))."</h3>";
                };
                
                if(isset($_POST['product'])){
                    echo "<h3>Product = ".product(checkData2($_POST['n1'],1), checkData2($_POST['n2'], 1), checkData2($_POST['n3'],1))."</h3>";
                ...
                // if(isset($_POST['product'])){
                //     echo "<h3>Product = ".product(checkData1($_POST['n1']), checkData1($_POST['n2']), checkData1($_POST['n3']))."</h3>";
                // }
            ?>
        </div>
