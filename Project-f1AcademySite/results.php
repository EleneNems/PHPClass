    ...
    <main>
        <div class="cover-section">
            ...
            <div class="result-content">
                <h1 class="fade-slide"><?= $raceName ?></h1>
            </div>
        </div>
        ...
        <div class="container_race fade-slide">
            <div class="race-left fade-slide delay">
                <img src="<?= $raceInfo['circuit_path'] ?>" alt="Circuit layout">
            </div>
            <div class="race-right">
                <h2 class="race-name fade-slide delay-2"><?= $raceInfo['name'] ?></h2>
                <p class="race-location fade-slide delay-3"><?= $raceInfo['location'] ?></p>
                <p class="race-date fade-slide delay-4">Start: <?= date('F j, Y', strtotime($raceInfo['start_date'])) ?>
                </p>
                <p class="race-date fade-slide delay-5">End: <?= date('F j, Y', strtotime($raceInfo['end_date'])) ?></p>
            </div>
        </div>
            ...
            <div class="results-container">
                <?php if ($sessions->num_rows > 0) {
                    ...
                    while ($session = mysqli_fetch_assoc($sessions)) {
                        ...
                        $delayClass = "fade-slide delay-" . $delayIndex++;
                        ?>
                        <div class="session-box <?= $delayClass ?>">
                    ...
                    <div class="session-box fade-slide delay-0">
        ...
        <script src="JS/Result_pop_up.js?v=2"></script>
